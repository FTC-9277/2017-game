...
public class BlueGlyphAuto extends HazMatAutonomous {
    ...
    public void body() throws InterruptedException {
        ...
        if(vuMark == RelicRecoveryVuMark.LEFT){
            ...
            while(robot.strafe.getPosition() < 75  && opModeIsActive() && !isStopRequested()){
            ...
            while(robot.strafe.getPosition() > -550 && opModeIsActive() && !isStopRequested()){
                robot.drive.strafeArcadeDrive(0.1,0,0);
                Log.d("Robot", "Strafe: "+ + robot.strafe.getPosition());
            }
            robot.drive.strafeArcadeDrive(0,0,0);
            ...
            while(robot.strafe.getPosition() > -950 && opModeIsActive() && !isStopRequested()){
                robot.drive.strafeArcadeDrive(0.1,0,0);
                Log.d("Robot", "Strafe: "+ + robot.strafe.getPosition());
            }
            robot.drive.strafeArcadeDrive(0,0,0);
